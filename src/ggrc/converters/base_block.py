...
class BlockConverter(object):
  ...
  def __init__(self, converter, object_class, class_name, operation,
               raw_headers=None, offset=None, rows=None):
...
class ExportBlockConverter(BlockConverter):
  def __init__(self, converter, object_class, fields, object_ids, class_name):
    # pylint: disable=too-many-arguments
